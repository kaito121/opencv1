...
string file_dst = "image2/"+file+"/DSC_"+name+"contdown_meido0_after2.jpg";//二値化
string file_dst2 = "image2/"+file+"/DSC_"+name+"contdown_meido0_after2_2tika.jpg";//二値化エッジ抽出画像
string file_dst3= "image2/"+file+"/DSC_"+name+"contdown_meido0_after2_2tika_mask.jpg";//mask画像
string file_dst4 = "image2/"+file+"/DSC_"+name+"contdown_meido0_after2_2tika_out.jpg";//カラーフィルタ処理画像
string file_dst5 = "image2/"+file+"/DSC_"+name+"contdown_meido0_after2_2tika_out_UP.jpg";//膨張処理画像
string file_dst6 = "image2/"+file+"/DSC_"+name+"contdown_meido0_after2_2tika_out_UP_mono.jpg";//密度検出画像
string file_dst7 = "image2/"+file+"/DSC_"+name+"contdown_meido0_after2_2tika_out_UP_mono_mitudo.jpg";//密度検出画像
...
//二値化
int thresh =100;
threshold(img_meido,img_dst,thresh,255,THRESH_BINARY);
