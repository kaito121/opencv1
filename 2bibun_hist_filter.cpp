...
//morphologyEx(img_cont,img_tmp,MORPH_CLOSE,element8,Point(-1,-1),1);
...
//エッジ抽出(二次微分)
Mat img_tmp1;
Laplacian(img_cont, img_tmp1, CV_32F, 3);
convertScaleAbs(img_tmp1, img_dst2, 1, 0);


GaussianBlur(img_dst2,img_ab2,Size(11,11),1);
bilateralFilter(img_ab2,img_aba,11,10,100);
//二値化
int thresh =100;
threshold(img_aba,img_dst3,thresh,255,THRESH_BINARY);
