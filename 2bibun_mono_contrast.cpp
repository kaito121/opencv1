...
string name = "1008";
string file = "cont";
string file_src = "image2/DSC_"+name+".jpg";//元画像
string file_cont = "image2/"+file+"/DSC_"+name+"contdown.jpg";//コントラスト
string file_dst = "image2/"+file+"/DSC_"+name+"contdown_after2.jpg";//二値化
string file_dst2 = "image2/"+file+"/DSC_"+name+"contdown_after2_2tika.jpg";//二値化エッジ抽出画像
string file_dst3= "image2/"+file+"/DSC_"+name+"contdown_after2_2tika_mask.jpg";//mask画像
string file_dst4 = "image2/"+file+"/DSC_"+name+"contdown_after2_2tika_out.jpg";//カラーフィルタ処理画像
string file_dst5 = "image2/"+file+"/DSC_"+name+"contdown_after2_2tika_out_UP.jpg";//膨張処理画像
string file_dst6 = "image2/"+file+"/DSC_"+name+"contdown_after2_2tika_out_UP_mono.jpg";//密度検出画像
string file_dst7 = "image2/"+file+"/DSC_"+name+"contdown_after2_2tika_out_UP_mono_mitudo.jpg";//密度検出画像
